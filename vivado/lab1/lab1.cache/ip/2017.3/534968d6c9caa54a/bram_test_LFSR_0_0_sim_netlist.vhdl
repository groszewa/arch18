...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lfsr_10bit is
  ...
  signal \lfsr_out_reg_n_0_[0]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[1]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[2]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[3]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[4]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[5]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[6]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[7]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[8]\ : STD_LOGIC;
  signal \lfsr_out_reg_n_0_[9]\ : STD_LOGIC;
...
\lfsr_reg[0]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[1]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[2]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[3]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[4]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[5]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[6]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[7]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[8]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
\lfsr_reg[9]__0\: unisim.vcomponents.FDRE
     port map (
      C => SR(0),
      CE => '1',
      D => '1',
...
addr_lfsr: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lfsr_10bit
     port map (
      ...
      \slv_reg2_reg[9]\(9 downto 0) => \slv_reg2_reg[9]\(9 downto 0),
      \slv_reg3_reg[9]\(9 downto 0) => \slv_reg3_reg[9]\(9 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
prn_generator: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lfsr
     port map (
      ...
      s00_axi_arvalid => s00_axi_arvalid,
      s00_axi_rvalid => \^s00_axi_rvalid\,
      \slv_reg2_reg[9]\(9 downto 0) => slv_reg2(9 downto 0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal axi_awready_reg_i_1_n_0 : STD_LOGIC;
...
axi_awready_reg_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => s00_axi_aresetn,
      O => axi_awready_reg_i_1_n_0
    );
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LFSR_v1_0
     port map (
      SR(0) => axi_awready_reg_i_1_n_0,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_araddr(3 downto 0) => s00_axi_araddr(3 downto 0),
      s00_axi_aresetn => s00_axi_aresetn,
      s00_axi_arready => s00_axi_arready,
