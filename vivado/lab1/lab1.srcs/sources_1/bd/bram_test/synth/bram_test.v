...
//Date        : Tue Feb 13 23:07:49 2018
//Host        : toad running 64-bit CentOS release 6.9 (Final)
//Command     : generate_target bram_test.bd
//Design      : bram_test
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bram_test,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bram_test,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_board_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "bram_test.hwdef" *) 
module bram_test
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  bram_test_LFSR_beta_0_0 LFSR_beta_0
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > bram_test blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bram_test_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  bram_test_axi_bram_ctrl_1_0 axi_bram_ctrl_1
  ...
  bram_test_axi_gpio_0_0 axi_gpio_0
  ...
  bram_test_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  (* BMM_INFO_PROCESSOR = "arm > bram_test axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bram_test_processing_system7_0_0 processing_system7_0
  ...
  bram_test_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
