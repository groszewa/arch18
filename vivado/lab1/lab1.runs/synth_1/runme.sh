...
HD_PWD='/home/ecelrc/students/agroszewski/arch18/vivado/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_test_wrapper.tcl
