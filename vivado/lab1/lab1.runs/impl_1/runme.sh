...
HD_PWD='/home/ecelrc/students/agroszewski/arch18/vivado/lab1/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bram_test_wrapper.tcl -notrace
