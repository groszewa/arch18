...
HD_PWD='/home/ecelrc/students/agroszewski/arch18/vivado/lab1/lab1.runs/bram_test_LFSR_beta_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_test_LFSR_beta_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_test_LFSR_beta_0_0.tcl
