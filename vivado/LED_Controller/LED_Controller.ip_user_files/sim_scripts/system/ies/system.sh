...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../LED_Controller.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../LED_Controller.srcs/sources_1/bd/system/ipshared/d5d3/hdl/verilog" \
       +incdir+"$ref_dir/../../../../LED_Controller.srcs/sources_1/bd/system/ipshared/e0a2/hdl" \
       +incdir+"../../../../LED_Controller.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../LED_Controller.srcs/sources_1/bd/system/ipshared/d5d3/hdl/verilog" \
       +incdir+"../../../../LED_Controller.srcs/sources_1/bd/system/ipshared/e0a2/hdl" \
