...
proc create_root_design { parentCell } {
  ...
  set LED_DutyCycle [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 LED_DutyCycle ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports LED_DutyCycle] [get_bd_intf_pins axi_gpio_0/GPIO]
