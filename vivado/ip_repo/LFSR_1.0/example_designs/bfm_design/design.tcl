proc create_ipi_design { offsetfile design_name } {
	...
	set LFSR_0 [ create_bd_cell -type ip -vlnv ecelrc:user:LFSR:1.0 LFSR_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores ecelrc:user:LFSR:1.0]]]]
